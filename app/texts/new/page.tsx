      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <section className="surface-card rounded-[32px] p-6 sm:p-8">
          ...
          <h1 className="mt-2 text-2xl font-semibold text-[var(--ink)]">
            Abra um novo texto base e escolha os outputs que vao nascer dele
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-7 text-[var(--ink-soft)]">
            Use esta area quando quiser cadastrar uma nova base. Depois, qualquer ajuste na base
            compartilhada pode ser retomado pelo workspace de um dos outputs criados.
          </p>
        </section>
